...
$("sidebarOpener").addEventListener("click",()=>{$("sidebar").classList.remove("fully-hidden");document.querySelector(".hub-main").classList.remove("sidebar-hidden");$("sidebarOpener").classList.remove("visible")});
